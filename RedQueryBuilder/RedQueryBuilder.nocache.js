function RedQueryBuilder() {
    var P = '',
        ...
        _ = '/',
        lb = '//',
        Qb = '38F3C4025EC78286963A0AE9DF90B56C',
        Rb = '54C3B7092ACFC5F9CAD7363BE5AB3FD0',
        Sb = '8E032B4D2F4789F82638F9FCBA6F1A5F',
        Wb = ':',
        pb = '::',
        Zb = '<script defer="defer">RedQueryBuilder.onInjectionDone(\'RedQueryBuilder\')<\/script>',
        hb = '<script id="',
        sb = '=',
        $ = '?',
        Tb = 'B722FC668A24C3F07C74A53B6E3F2C0B',
        ub = 'Bad handler "',
        Ub = 'CD2C110F32F7293DC1D23C5FC63BB3BC',
        Vb = 'D698AFC91995420B1E00E43F8ECAAA55',
        Yb = 'DOMContentLoaded',
        Q = 'RedQueryBuilder',
        eb = 'RedQueryBuilder.nocache.js',
        ob = 'RedQueryBuilder::',
        jb = 'SCRIPT',
        gb = '__gwt_marker_RedQueryBuilder',
        kb = 'base',
        cb = 'baseUrl',
        T = 'begin',
        S = 'bootstrap',
        ...
        qb = 'gwt:property',
        Ob = 'hosted.html?RedQueryBuilder',
        Jb = 'ie6',
        Ib = 'ie8',
        Hb = 'ie9',
        yb = 'iframe',
    ...
    w[Cb] = function () {
        ...
        if (function () {
            return b.indexOf(Db) != -1
        }()) return Db;
        if (function () {
            return b.indexOf(Eb) != -1
        }()) return Fb;
        if (function () {
            return b.indexOf(Gb) != -1 && n.documentMode >= 9
        }()) return Hb;
        if (function () {
            return b.indexOf(Gb) != -1 && n.documentMode >= 8
        }()) return Ib;
        if (function () {
    ...
    RedQueryBuilder.onScriptLoad = function () {
        if (I) {
            r = true;
            C()
        }
    };
    RedQueryBuilder.onInjectionDone = function () {
        q = true;
        o && o({
            moduleName: Q,
            sessionId: p,
    ...
    function O() {
        if (!s) {
            ...
            if (n.removeEventListener) {
                n.removeEventListener(Yb, O, false)
            }
            if (N) {
                clearInterval(N)
            }
    ...
    if (n.addEventListener) {
        n.addEventListener(Yb, function () {
            J();
            O()
        }, false)
    }
